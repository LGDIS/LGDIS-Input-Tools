...
JAVA_STDERR=$APP_HOME/log/java_queue.err

JAVA_HOME=${JAVA_HOME}

### set jvm's params ###
JVM_ARGS=java.util.logging.config.file=$APP_HOME/config/queue_logging.properties
...
JAVA_ARGS="$APP_HOME/config/queue.yml"
