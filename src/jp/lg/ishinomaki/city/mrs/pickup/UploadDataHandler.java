...
public abstract class UploadDataHandler implements PickupDataHandler {

    // ログ用
    private static Logger log = Logger.getLogger(UploadDataHandler.class
            .getSimpleName());
    ...
    /**
     * Redmineへ送信する際の設定値を取得するための抽象メソッドです。
     * 
     * @return
     */
    abstract Map<String, String> getConfig();
     ...
     *            入力元識別子
     */
    public UploadDataHandler(int mode, String inputId) {
        this.mode = mode;
